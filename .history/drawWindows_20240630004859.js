export function logToWorld(message) {
    ...
    worldWindow.scrollTop = worldWindow.scrollHeight;  // Auto-scroll to bottom TODO add scrollToBottom checkbox and call this via if check. NEEDs to no be at bottom
