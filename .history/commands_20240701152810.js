...
export function move(direction) {
    ...
    const exit = currentRoom.exits.fin
    if(currentRoom.exits[direction]) { // Check if the player can move in the specified direction
        player.move(currentRoom.exits.gotoRoom);
